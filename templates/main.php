          ...
          <div class="lot__info">
            ...
            <div class="lot__state">
              <div class="lot__rate">
                ...
                <span class="lot__cost"><?= formatPrice($lots[$key]['price']);?></span>
              </div>
              <?php
                // Подсвечиваем красным date_expire если осталось меньше суток
                if (floor((strtotime($lots[$key]['date_expire']) - strtotime('tomorrow')) / 3600)) {
                  $classname = '';
                } else {
              ...
              <div class="lot__timer timer <?=$classname;?>">
                <?= showDaysExpire($lots[$key]['date_expire']);?>
              </div>
            </div>
          </div>
        </li>
